                            ...
                            <div class="card">
                                   ...
                                   <div class="col-sm-12 col-md-1 card-title">
                                    <a href="{{ route('Category.create') }}" class="btn btn-block bg-gradient-primary">
                                        ...
                                        <div class="card-tools">
                                            <form method="get" action="{{ route('Categorytk') }}">
                                                @csrf
                                ...
                                <div class="card-body">
                                    <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                            ...
                                            <div class="col-sm-12">
                                                <table class="table table-hover table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="text-center">
                                                            <td scope="row">{{ $Categorys->firstItem() + $key }}</td>
                                                            <td>
                                                                {{$Category->name}}
                                                            </td>
                                                            <td>
                                                                ...
                                                                <form id="delete-form-{{ $Category->id }}"
                                                                    ...
                                                                    <input type="hidden" name="_token"
                                                                        value="{{csrf_token()}}">
                                                                    <button class="btn btn-sm btn-danger rounded-0" onclick="delConfirm({{ $Category->id }},'{{$Category->name}}')">
                                                                        Xóa
                                                                    </button>
                                                                </form>
                                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="d-flex justify-content-center">{{$Categorys->links('vendor.pagination.paginator')}}
                                            </div>
                                        </div>
                                    </div>
                                </div>
