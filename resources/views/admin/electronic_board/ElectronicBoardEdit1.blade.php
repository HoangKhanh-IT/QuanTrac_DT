                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Sửa bảng điện tử</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="post" action="{{ route('ElectronicBoard.edit',$ElectronicBoard->id) }}">
                                    @csrf
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="name" id="name" type="text" class="form-control"
                                                        placeholder="Tên ..." value="{{ $ElectronicBoard->name }}">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    @foreach ($ObservationStations as $ObservationStation)
                                                        <option {{ $ElectronicBoard->stationid == $ObservationStation->id ?"Selected":""  }}
                                             ...
                                             <div class="col-sm-6">
                                                 ...
                                                 class="form-control" value="{{ $ElectronicBoard->username }}"
                                              ...
                                              <div class="col-sm-6">
                                                  <div class="form-group">
                                                      ...
                                                      <input name="pass" id="pass" type="text" class="form-control"
                                                          placeholder="Mật khẩu ..." value="{{ $ElectronicBoard->pass }}">
                                                  </div>
                                              </div>
                                               <div class="col-sm-6">
                                                   <div class="form-group">
                                                       ...
                                                       <input name="ipaddress" id="ipaddress" type="text"
                                                           ...
                                                           value="{{ $ElectronicBoard->ipaddress }}">
                                                   </div>
                                               </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="description" id="description" type="text"
                                                            class="form-control"
                                                            placeholder="Mô tả ..." value="{{ $ElectronicBoard->description }}">
                                                    </div>
                                                </div>
                                        </div>
                                        <!-- /.card-body -->
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <a href="{{ route('ElectronicBoard') }}" class="btn btn-default float-right">
                                                Quay lại
                                            </a>
                                        </div>
                                </form>
