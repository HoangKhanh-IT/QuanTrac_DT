                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                value="{{ $ElectronicBoard->name }}" placeholder="Tên ...">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="coordx" id="coordx" type="text" class="form-control"
                                                      value="{{ $ElectronicBoard->coordx }}" placeholder="Tọa độ X ...">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="coordy" id="coordy" type="text" class="form-control"
                                                      value="{{ $ElectronicBoard->coordy }}" placeholder="Tọa độ Y ...">
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    value="{{ $ElectronicBoard->note }}" placeholder="Mô tả ...">
                                                </div>
                                            </div>
                                        </div>
                                        <!-- /.card-body -->
