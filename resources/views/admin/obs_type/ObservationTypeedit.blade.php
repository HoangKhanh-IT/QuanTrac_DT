                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Sửa loại hình</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="post"
                                    action="{{ route('ObservationType.edit',$ObservationTypeItem->id) }}">
                                    @csrf
                                    <div class="card-body">
                                        <div class="form-group" data-select2-id="76">
                                            ...
                                            <select class="form-control select2 select2-hidden-accessible"
                                                ...
                                                <option
                                                    {{ $ObservationType->id === $ObservationTypeItem->parentid? 'selected' : '' }}
                                                ...
                                                <option
                                                    {{ $ObservationType1->id === $ObservationTypeItem->parentid? 'selected' : '' }}
