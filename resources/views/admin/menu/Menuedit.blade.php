                                ...
                                <form method="post" action="{{ route('menu.edit',$MenuItem->id) }}">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input name="name" id="name" type="text" value="{{ $MenuItem->name }}"
                                                class="form-control" placeholder="Tên chức năng ...">
                                        </div>
                                        <div class="form-group">
                                            <label>Link (<span style="color: red;">*</span>)</label>
                                            <input name="Link" id="Link" type="text" value="{{ $MenuItem->Link }}"
                                                class="form-control" placeholder="Đường dẫn mặc định ...">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label>Tiêu đề</label>
                                            <input name="title" id="title" type="text" value="{{ $MenuItem->title }}"
                                                class="form-control" placeholder="Tiêu đề ...">
                                        </div>
                                        <div class="form-group">
                                            <label>Mô tả</label>
                                            <input name="description" id="description"
                                                value="{{ $MenuItem->description }}" type="text" class="form-control"
                                                placeholder="Mô tả ...">
                                        </div>
                                        <div class="form-group">
                                            <label>Thứ tự hiển thị (<span style="color: red;">*</span>)</label>
                                            <input name="oder" id="oder" type="text" value="{{ $MenuItem->oder }}"
