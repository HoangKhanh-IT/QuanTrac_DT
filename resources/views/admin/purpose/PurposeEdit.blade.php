                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Sửa mục đích sử dụng</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="post" action="{{ route('Purpose.edit',$Purpose->id) }}">
                                    @csrf
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label>Tên (<span style="color: red;">*</span>)</label>
                                        <input name="name" id="name" value="{{ $Purpose->name }}" type="text" class="form-control"
                                                placeholder="Mục đích sử dụng ...">
                                        </div>
                                        <div class="form-group">
                                            <label>Mô tả</label>
                                            <input name="description" id="description" value="{{ $Purpose->description }}" type="text" class="form-control"
                                                placeholder="Mô tả ...">
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <a href="{{ route('Purpose') }}" class="btn btn-default float-right">
                                            Quay lại
                                        </a>
                                    </div>
                                </form>
