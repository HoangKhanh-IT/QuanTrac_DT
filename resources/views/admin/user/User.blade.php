...
<head>
    ...
    <!-- Toastr -->
    <script src="{{ asset('public/admin/plugins/toastr/toastr.min.js') }}">
    </script>
</head>
                            ...
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <div class="col-sm-12 col-md-1 card-title">
                                        <a href="{{ route('users.create') }}" class="btn btn-block bg-gradient-primary">
                                            Thêm
                                        </a>
                                    </div>
                                    <div class="card-tools">
                                        <form method="get" action="{{ route('userstk') }}">
                                            @csrf
                                            <div class="input-group input-group-prepend" style="width: 250px;">
                                                <input type="text" name="search" class="form-control float-right"
                                                    placeholder="Họ tên, Tài khoản, Email">
                                ...
                                <div class="card-body">
                                    <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                                ...
                                                <table class="table table-hover table-bordered">
                                                    <thead>
                                                        <tr class="text-center">
                                                            ...
                                                            <th scope="col" class="">Nhóm người dùng</th>
                                                                ...
                                                                <div class="btn-group btn-group-sm">
                                                                    ...
                                                                    <form id="delete-form-{{ $User->id }}"
                                                                        ...
                                                                        <input type="hidden" name="_token"
                                                                            value="{{csrf_token()}}">
                                                                        <button class="btn btn-sm btn-danger rounded-0" onclick="delConfirm({{ $User->id }},'{{$User->name}}')">
                                                                            Xóa
                                                                        </button>
                                                                    </form>
                                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="d-flex justify-content-center">{{$Users->links()}}
                                            </div>
                                        </div>
                                    </div>
                                </div>
