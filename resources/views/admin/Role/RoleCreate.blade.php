                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Thêm mới nhóm người dùng</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="post" action="{{ route('role.create') }}">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input name="tennhom" id="tennhom" type="text" class="form-control"
                                        ...
                                        <div class="row">
                                            @foreach($chucnangs as $key => $chucnang)
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                <label>{{ $chucnang->name }}</label>
                                                @foreach($chucnang->permissions as $key => $permission)
