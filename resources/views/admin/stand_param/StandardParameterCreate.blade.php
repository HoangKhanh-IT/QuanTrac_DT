                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Thêm mới Quy chuẩn - Chi tiêu</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="post" action="{{ route('StandardParameter.create') }}">
                                    @csrf
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="js-example-basic-single form-control"
                                                name="purpose" id="purpose" style="width: 100%;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="js-example-basic-single form-control"
                                                ...
                                                <option value="{{ $paramerter->id }}">{{ $paramerter->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                             ...
                                             <input name="analysismethod" id="analysismethod" type="text"
                                                 class="form-control"
                                                 placeholder="Phương pháp phân tích ...">
                                         </div>
                                    </div>
                                    <!-- /.card-body -->
