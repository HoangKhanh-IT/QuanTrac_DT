                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="type" id="type" type="text"
                                                        class="form-control" placeholder="Loại ...">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="employees" id="employees" type="text"
                                                        class="form-control" placeholder="Số lao động ...">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="totalInvestment" id="totalInvestment" type="text"
                                                        class="form-control" placeholder="Tổng vốn ...">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="profession" id="profession" type="text"
                                                        class="form-control" placeholder="Ngành nghề ...">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
