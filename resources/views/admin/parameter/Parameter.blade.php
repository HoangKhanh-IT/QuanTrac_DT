        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="row mb-12">
                        <div class="col-sm-12">
                            <h2>Quản lý thông số quan trắc</h2>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header">
                                   <div class="col-sm-12 col-md-1 card-title">
                                    <a href="{{ route('Parameter.create') }}" class="btn btn-block bg-gradient-primary">
                                        Thêm
                                    </a>
                                    </div>
                                        <div class="card-tools">
                                            <form method="get" action="{{ route('Parametertk') }}">
                                                @csrf
                                                <div class="input-group input-group-prepend" style="width: 250px;">
                                                    <input type="text" name="search" class="form-control float-right" placeholder="Mã, tên thông số">
                                                ...
                                                <table class="table table-hover table-bordered">
                                                    <thead>
                                                        <tr class="text-center">
                                                            ...
                                                            <th scope="col" class="">Mã thông số</th>
                                                            <th scope="col" class="">Tên thông số</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="text-center">
                                                            <td scope="row">{{ $parameters->firstItem() + $key }}</td>
