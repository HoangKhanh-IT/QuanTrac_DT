                    ...
                    <div class="row mb-12">
                        <div class="col-sm-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="post" action="{{ route('Parameter.edit',$Parameter->id) }}">
                                    @csrf
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label>Mã thông số (<span style="color: red;">*</span>)</label>
                                        <input name="code" id="code" value="{{ $Parameter->code }}" type="text" class="form-control"
                                                placeholder="Mã thông số ...">
                                        </div>
                                        <div class="form-group">
                                            <label>Tên thông số (<span style="color: red;">*</span>)</label>
                                            <input name="name" id="name" value="{{ $Parameter->name }}" type="text" class="form-control"
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <a href="{{ route('Parameter') }}" class="btn btn-default float-right">
                                            Quay lại
                                        </a>
                                    </div>
                                </form>
