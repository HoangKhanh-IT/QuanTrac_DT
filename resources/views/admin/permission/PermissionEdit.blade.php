                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-header">
                                    <h3 class="card-title">Sửa quyền chức năng</h3>
                                </div>

                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="post" action="{{ route('permission.edit',$PermissionItem->id) }}">
                                    @csrf
                                    <div class="card-body">
                                            ...
                                            <select class="form-control select2 select2-hidden-accessible"
                                                ...
                                                @foreach($chucnangs as $nhomCN)
                                                    @if ($nhomCN ->parent_id == null)
                                                        ...
                                                        <?php  $value = $item->id; $valueItem = $PermissionItem->menus_id;  ?>
                                                            @if ($item->parent_id == $nhomCN->id)
                                                                <option <?php  if(str_contains($value, $valueItem) !== false){ echo 'selected'; } ?> readonly="readonly" value="{{ $item->id.'_'.$item->code }}">-----{{ $item->name }}
                                                                </option>
                                                            @endif
                                                        @endforeach
                                                    @endif
                                        ...
                                        <div class="form-group">
                                            ...
                                            <table class="table table-bordered" id="dynamicTable">
                                                ...
                                                <tr>
                                                    <td><input type="text" name="addmore[0][name]"   placeholder="Action" value="{{ $PermissionItem->name }}" class="form-control" /></td>
                                                <td><input type="text" name="addmore[0][display_name]" value="{{ $PermissionItem->display_name }}" placeholder="Mô tả" class="form-control" /></td>
