                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Cập nhật loại địa danh</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="post" action="{{ route('LocationType.edit',$LocationType->id) }}">
                                    @csrf
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label>Tên (<span style="color: red;">*</span>)</label>
                                            <input name="name" id="name" type="text" class="form-control"
                                        value="{{ $LocationType->name }}"   placeholder="Tên ...">
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <a href="{{ route('LocationType') }}" class="btn btn-default float-right">
                                            Quay lại
                                        </a>
                                    </div>
                                </form>
