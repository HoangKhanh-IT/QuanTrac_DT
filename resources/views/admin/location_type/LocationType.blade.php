                            ...
                            <div class="card">
                                ...
                                <div class="card-header">
                                   <div class="col-sm-12 col-md-1 card-title">
                                    <a href="{{ route('LocationType.create') }}" class="btn btn-block bg-gradient-primary">
                                        Thêm
                                    </a>
                                    </div>
                                        <div class="card-tools">
                                            <form method="get" action="{{ route('LocationTypetk') }}">
                                                @csrf
                                                <div class="input-group input-group-prepend" style="width: 250px;">
                                                    <input type="text" name="search" class="form-control float-right" placeholder="Tên">
                                ...
                                <div class="card-body">
                                    <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                            ...
                                            <div class="col-sm-12">
                                                <table class="table table-hover table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="text-center">
                                                            <td scope="row">{{ $LocationTypes->firstItem() + $key }}</td>
                                                            <td>
                                                                {{$LocationType->name}}
                                                            </td>
                                                            <td>
                                                                <div class="btn-group btn-group-sm">
                                                                <a href="{{route('LocationType.edit',$LocationType->id)}}"
                                        ...
                                        <div class="row">
                                            <div class="d-flex justify-content-center">{{$LocationTypes->links('vendor.pagination.paginator')}}
                                            </div>
                                        </div>
                                    </div>
                                </div>
