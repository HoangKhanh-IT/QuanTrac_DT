                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Cập nhật trạm quan trắc</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="post"
                                    action="{{ route('Observationstation.edit',$Observationstation->id) }}">
                                    @csrf
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                placeholder="Mã trạm ..." value="{{ $Observationstation->code }}">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="coordx" id="coordx" type="text" class="form-control"
                                                        ...
                                                        value="{{ $Observationstation->coordx }}">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="coordy" id="coordy" type="text" class="form-control"
                                                        ...
                                                        value="{{ $Observationstation->coordy }}">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="js-example-basic-single form-control"
                                                        ...
                                                        <option
                                                            {{ $Observationstation->categoryid == $Category->id ? "selected":"" }}
                                                    ...
                                                    <select class="js-example-basic-single form-control" name="basin">
                                                        ...
                                                        @foreach($Basins as $Basinparent)
                                                            @if ($Basinparent->parentriverbasinid == null)
                                                                <option {{ $Observationstation->basinid === $Basinparent->id ? 'selected' : '' }} value="{{$Basinparent->id}}">{{$Basinparent->name}}
                                                                </option>
                                                                @foreach ( $Basins as $Basinparent1 )
                                                                    @if ($Basinparent1->parentriverbasinid == $Basinparent->id)
                                                                    <option {{ $Observationstation->basinid === $Basinparent1->id ? 'selected' : '' }} value="{{$Basinparent1->id}}">
                                                                        --{{$Basinparent1->name}}
                                                                    </option>
                                                                    @endif
                                                                @endforeach
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="js-example-basic-single form-control"
                                                        ...
                                                        <option
                                                            {{ $Observationstation->locationid == $Location->id ? "selected":"" }}
                                                            value="{{ $Location->id }}">
                                                            {{ $Location->name }}
                                                        </option>
                                                        @endforeach
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="js-example-basic-single form-control"
                                                        ...
                                                        <option
                                                            {{ $Observationstation->districtid == $District -> id ? "selected":"" }}
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="maintenance" id="maintenance" type="text"
                                                        ...
                                                        value="{{ $Observationstation->maintenance }}">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="js-example-basic-single form-control" id="active"
                                                        name="active">
                                                        <option {{ $Observationstation->active =="Y" ? "selected":"" }} value="Y">Đang
                                                            hoạt động</option>
                                                        <option {{ $Observationstation->active =="N" ? "selected":"" }}
                                                            value="N">Không</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="ftpusername" id="ftpusername" type="text"
                                                        ...
                                                        value="{{ $Observationstation->ftpusername }}">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="ftppassword" id="ftppassword" type="text"
                                                        ...
                                                        value="{{ $Observationstation->ftppassword }}">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
...
<script type="text/javascript">
    $(document).ready(function () {
        var purposeItem = {!! $Observationstation->StandardParameters->toJson() !!};
        var collectionObsTypes = {!! $Observationstation->ObservationTypes->toJson() !!};
        var ObsSTS = [];
        var ParamItem = [];
        var ObservationTypesItem = document.getElementsByName("ObservationTypes[]");
        var ParamertersItem = document.getElementsByName("Parameters[]");
        if (collectionObsTypes.length > 0) {
            //alert(collectionObsTypes.length);
            collectionObsTypes.forEach(element => {
                ObsSTS.push(element.id);
                //ParamItem.push(element.parameterid);
                //alert(element.id);
                //$(ObservationTypesItem).select2('val', element.name);

            });
        }

        if (purposeItem.length > 0) {
             purposeItem.forEach(element => {
                ParamItem.push(element.parameterid +'_'+element.id);
                if (element.id == "396") {
            ...
            //
            //alert(purposeItem[0].standardid);
            //alert(purposeItem[0].purposeid);
            $("#standards").val(purposeItem[0].standardid).change();
            $("#purposes").val(purposeItem[0].purposeid).change();
        }
        $(ObservationTypesItem).select2().val(ObsSTS).trigger('change');
        $(ParamertersItem).select2().val(ParamItem).trigger('change');
        addOption("chitieu[0][parameter]", lstParam);
