                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Cập nhật lưu vực sông</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="post" action="{{ route('Basin.edit',$Basin->id) }}">
                                    @csrf
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="riverid" id="riverid" type="text" class="form-control"
                                                        placeholder="Mã ..." value="{{ $Basin->riverid }}">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="name" id="name" type="text" class="form-control"
                                                        placeholder="Tên ..." value="{{ $Basin->name }}">
                                                </div>
                                            </div>
                                             <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="master" id="master" type="text" class="form-control"
                                                        placeholder="Chủ công trình ..." value="{{ $Basin->master }}">
                                                </div>
                                            </div>
                                                    ...
                                                    <select onchange="getComboA(this)"
                                                        ...
                                                        @foreach($Basins as $Basinparent)
                                                            @if ($Basinparent->parentriverbasinid == null)
                                                                <option {{ $Basinparent->id === $Basin->parentriverbasinid ? 'selected' : '' }} value="{{$Basinparent->id}}">{{$Basinparent->name}}
                                                                </option>
                                                                @foreach ( $Basins as $Basinparent1 )
                                                                    @if ($Basin->parentriverbasinid == $Basinparent1->id)
                                                                    <option {{ $Basin->parentriverbasinid === $Basinparent1->id ? 'selected' : '' }} value="{{$Basinparent1->id}}">
                                                                        --{{$Basinparent1->name}}
                                                                    </option>
                                                                    @endif
                                                                @endforeach
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="capacity" id="capacity" type="text" class="form-control"
                                                        placeholder="Dung tích ..." value="{{$Basin->capacity}}">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="netcapacity" id="netcapacity" type="text" class="form-control"
                                                        placeholder="Dung tích hữu ích..." value="{{ $Basin->netcapacity }}">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="deadcapacity" id="deadcapacity" type="text" class="form-control"
                                                        placeholder="Dung tích chết..." value="{{ $Basin->deadcapacity }}">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="surfaceareanwt" id="surfaceareanwt" type="text" class="form-control"
                                                        placeholder="Diện tích mặt hồ của mực nước dâng bình thường..." value="{{ $Basin->surfaceareanwt }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="risingofnormalwaterlevel" id="risingofnormalwaterlevel" type="text" class="form-control"
                                                        placeholder="Diện tích mặt hồ ứng với mực nước dâng bình thường..." value="{{ $Basin->risingofnormalwaterlevel }}">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="deadwaterlevel" id="deadwaterlevel" type="text" class="form-control"
                                                        placeholder="Mực nước chết..." value="{{ $Basin->deadwaterlevel }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="beginning" id="beginning" type="text" class="form-control"
                                                        placeholder="Điểm đầu..." value="{{ $Basin->beginning }}">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="termini" id="termini" type="text" class="form-control"
                                                        placeholder="Điểm cuối..." value="{{ $Basin->termini }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="length" id="length" type="text" class="form-control"
                                                        placeholder="Chiều dài (km)..." value="{{ $Basin->length }}">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="riverbasinarea" id="riverbasinarea" type="text" class="form-control"
                                                        placeholder="Diện tích lưu vực ..." value="{{ $Basin->riverbasinarea }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="averageflowrate" id="averageflowrate" type="text" class="form-control"
                                                        placeholder="Lưu lượng trung bình..." value="{{ $Basin->averageflowrate }}">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="normalwaterlevel" id="normalwaterlevel" type="text" class="form-control"
                                                        placeholder="Mực nước dâng bình thường ..." value="{{ $Basin->normalwaterlevel }}">
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="standard" id="standard" type="text" class="form-control"
                                                        placeholder="Tiêu chuẩn ..." value="{{ $Basin->standard }}">
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="purpose" id="purpose" type="text" class="form-control"
                                                        placeholder="Mục đích sử dụng ..." value="{{ $Basin->purpose }}">
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="description" id="description" type="text" class="form-control"
                                                        placeholder="Mô tả ..." value="{{ $Basin->description }}">
                                                </div>
                                            </div>
                                        </div>
                                        <!-- /.card-body -->
