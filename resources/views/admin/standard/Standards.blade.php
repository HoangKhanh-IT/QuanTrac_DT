                            ...
                            <div class="card">
                                ...
                                <div class="card-header">
                                   <div class="col-sm-12 col-md-1 card-title">
                                    <a href="{{ route('Standard.create') }}" class="btn btn-block bg-gradient-primary">
                                        Thêm
                                    </a>
                                    </div>
                                        <div class="card-tools">
                                            <form method="get" action="{{ route('Standardtk') }}">
                                                @csrf
                                                <div class="input-group input-group-prepend" style="width: 250px;">
                                                    <input type="text" name="search" class="form-control float-right" placeholder="Tên, ký hiệu, cơ quan ban hành, loại hình">
                                                ...
                                                <table class="table table-hover table-bordered">
                                                    <thead>
                                                        <tr class="text-center">
                                                            ...
                                                            <th scope="col" class="">Tên quy chuẩn</th>
                                                            <th scope="col" class="">Kí hiệu</th>
                                                            <th scope="col" class="">Loại hình</th>
                                                            <th scope="col" class="">Ngày ban hành</th>
                                                            <!-- <th scope="col" class="">Đơn vị ban hành</th> -->
                                                            <th scope="col" class="">Tệp đính kèm</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="text-center">
                                                            <td scope="row">{{ $Standards->firstItem() + $key }}</td>
                                                            <td>{{$Standard->name}}</td>
                                                            <td>
                                                                {{$Standard->symbol}}
                                                            </td>
                                                            <td>
                                                                {{$Standard->ObservationType->name}}
                                                            </td>
                                                            <td>
