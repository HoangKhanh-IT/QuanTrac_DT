                                ...
                                <div class="card-header">
                                        <div class="col-sm-12 col-md-1 card-title">
                                            ...
                                            <div class="card-tools">
                                                <form method="get" action="{{ route('Posttk') }}">
                                                    @csrf
                                                    <div class="input-group input-group-addon" style="width: 250px;">
                                                        <input type="text" name="search" class="form-control float-right" placeholder="Tiêu đề, Nội dung, Tác giả, Tên chuyên mục">
                                                ...
                                                <table class="table table-hover table-bordered">
                                                    <thead>
                                                        <tr class="text-center">
                                                            ...
                                                            <th scope="col" class="">Tiêu đề bài viết</th>
                                                            <th scope="col" class="">Tác giả</th>
                                                            <!-- <th scope="col" class="">Hình ảnh</th> -->
                                                            <th scope="col" class="">Tóm tắt nội dung</th>
                                                            <th scope="col" class="">Trạng thái</th>
                                                            <th scope="col" class="">Chuyên mục</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="text-center">
                                                            ...
                                                            <td>{{$Post->title}}</td>
                                                          <!--   <td><img src="{{asset('public/uploads/post/thumbnail/'.$Post->image)}}" height="100",width="100"></td> -->
                                                           <td>{{$Post->authors}}</td>
                                                            <td>{!!$Post->desc!!}</td>
                                                            <td>
                                                                @if($Post->status==0)
