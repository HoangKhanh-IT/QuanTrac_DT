                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Cập nhật tổ chức</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="post" action="{{ route('Organization.edit',$Organization->id) }}">
                                    @csrf
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label>Tên (<span style="color: red;">*</span>)</label>
                                        <input name="name" id="name" value="{{ $Organization->name }}" type="text" class="form-control"
                                                placeholder="Tên ...">
                                        </div>
                                        <div class="form-group">
                                            <label>Mô tả</label>
                                            <input name="description" id="description" value="{{ $Organization->description }}" type="text" class="form-control"
                                                placeholder="Mô tả ...">
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <a href="{{ route('Organization') }}" class="btn btn-default float-right">
                                            Quay lại
                                        </a>
                                    </div>
                                </form>
