                            ...
                            <div class="card">
                                ...
                                <div class="card-header">
                                   <div class="col-sm-12 col-md-1 card-title">
                                    <a href="{{ route('Place.create') }}" class="btn btn-block bg-gradient-primary">
                                        Thêm
                                    </a>
                                    </div>
                                        <div class="card-tools">
                                            <form method="get" action="{{ route('Placetk') }}">
                                                @csrf
                                                <div class="input-group input-group-prepend" style="width: 250px;">
                                                    <input type="text" name="search" class="form-control float-right" placeholder="Tên địa danh, mô tả, loại địa danh">
                                ...
                                <div class="card-body">
                                    <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                                ...
                                                <table class="table table-hover table-bordered">
                                                    <thead>
                                                        <tr class="text-center">
                                                            ...
                                                            <th scope="col" class="">Tên địa danh</th>
                                                            <th scope="col" class="">Loại địa danh</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="text-center">
                                                            <td scope="row">{{ $Locations->firstItem() + $key }}</td>
                                                            <td>
                                                                {{$Location->name}}
                                                            </td>
                                                            <td>
                                        ...
                                        <div class="row">
                                            <div class="d-flex justify-content-center">{{$Locations->links('vendor.pagination.paginator')}}
                                            </div>
                                        </div>
                                    </div>
                                </div>
