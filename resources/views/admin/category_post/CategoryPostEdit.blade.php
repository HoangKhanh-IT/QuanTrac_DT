                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Sửa danh mục tin bài</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="post" action="{{ route('CatePost.edit',$CategoryPostItem->id) }}">
                                    @csrf
                                    <div class="card-body">
                                            ...
                                            <select class="form-control select2 select2-hidden-accessible"
                                                ...
                                                @foreach($CategoryPosts as $CategoryPost)
                                                    @if ($CategoryPost->parentcateid == null)
                                                        <option
                                                            {{ $CategoryPost->id === $CategoryPostItem->parentcateid? 'selected' : '' }}
                                                        ...
                                                        @foreach ( $CategoryPosts as $CategoryPost1 )
                                                            ...
                                                            <option
                                                                {{ $CategoryPost1->id === $CategoryPostItem->parentcateid? 'selected' : '' }} value="{{$CategoryPost1->id}}"> --{{$CategoryPost1->name}}
                                                            </option>
                                                            @endif
                                                        @endforeach
                                                    @else
